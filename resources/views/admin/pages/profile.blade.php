...
<!-- Form foto tentang panti -->
<div class="card mt-4">
    <div class="card-header">
        <h3 class="m-0"><i class="fas fa-images me-2"></i>Foto Panti (Maksimal 6 Foto)</h3>
    </div>
    <div class="card-body">
        @if (session('error'))
        ...
        <div class="row">
            <div class="col-md-6">
                <form action="{{ route('admin.tentang-panti.foto.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
            ...
            <div class="col-md-6">
                <div class="alert alert-info">
                    ...
                    Foto-foto ini akan ditampilkan di halaman profil panti. Maksimal 6 foto yang dapat diunggah.
                </div>
            </div>
        </div>
        ...
        <div class="mt-4">
            <h4>Foto-foto Panti</h4>
            @if(isset($tentang) && $tentang->galeriFoto && $tentang->galeriFoto->count() > 0)
                <div class="row galeri-foto">
                    @foreach($tentang->galeriFoto as $foto)
                        <div class="col-md-4 col-sm-6 mb-3">
                            <div class="foto-item">
                                <img src="{{ asset('storage/' . $foto->foto_path) }}" class="img-fluid" alt="Foto Panti" onerror="this.src='/api/placeholder/350/200'">
                                <div class="foto-actions">
                                    <form action="{{ route('admin.tentang-panti.foto.destroy', $foto->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus foto ini?');">
                                        @csrf
                                        @method('DELETE')
            ...
            @else
                <div class="no-data-container">
                    ...
                    <div class="no-data-text">
                        Belum ada foto yang diunggah. Silakan unggah foto panti.
                    </div>
                </div>
            @endif
        </div>
