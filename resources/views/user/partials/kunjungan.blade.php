...
<section id="jadwal-kunjungan" class="scrollspy-section jadwal-section padding-large">
    <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 jadwal-image-container">
                    <div class="jadwal-image-wrapper">
                        <img src="{{ asset('assets/images/visit.jpg') }}" alt="Jadwal Kunjungan Panti Asuhan Rumah Harapan" class="jadwal-image">
